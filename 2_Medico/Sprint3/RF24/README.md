...
Important: It will not work with Raspberry Pi 3 Model!
...
## Execute test to send from one Raspberry Pi:

	sudo ./send_struct
	
## Execute test to receive in the other Raspberry Pi:

	sudo ./receive_struct
	
## This project was forked and adapted by cljunior from https://github.com/TMRh20/RF24 and copied into STAGIOP-TR project.	
