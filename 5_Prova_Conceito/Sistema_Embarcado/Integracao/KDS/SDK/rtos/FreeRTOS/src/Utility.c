...
**     Date/Time   : 2015-04-30, 17:01, # CodeGen: 23
**     Abstract    :
...
**         WeekDay                 - byte Utility_WeekDay(uint16_t year, uint8_t month, uint8_t day);
**         ReadEscapedName         - byte Utility_ReadEscapedName(const unsigned char *filename, uint8_t...
**         xatoi                   - byte Utility_xatoi(const unsigned char **str, int32_t *res);
**         ScanDate                - byte Utility_ScanDate(const unsigned char **str, uint8_t *day, uint8_t...
**         ScanTime                - byte Utility_ScanTime(const unsigned char **str, uint8_t *hour, uint8_t...
**         ScanDecimal8uNumber     - byte Utility_ScanDecimal8uNumber(const unsigned char **str, uint8_t *val);
**         ScanDecimal8sNumber     - byte Utility_ScanDecimal8sNumber(const unsigned char **str, signed char *val);
**         ScanDecimal16uNumber    - byte Utility_ScanDecimal16uNumber(const unsigned char **str, uint16_t *val);
**         ScanDecimal16sNumber    - byte Utility_ScanDecimal16sNumber(const unsigned char **str, int16_t *val);
**         ScanDecimal32uNumber    - byte Utility_ScanDecimal32uNumber(const unsigned char **str, uint32_t *val);
...
**         ScanHex8uNumber         - byte Utility_ScanHex8uNumber(const unsigned char **str, uint8_t *val);
**         ScanHex8uNumberNoPrefix - byte Utility_ScanHex8uNumberNoPrefix(const unsigned char **str, uint8_t *val);
**         ScanHex16uNumber        - byte Utility_ScanHex16uNumber(const unsigned char **str, uint16_t *val);
...
**         strtailcmp              - byte Utility_strtailcmp(uint8_t *str, uint8_t *tail);
**         strlen                  - word Utility_strlen(const char *);
**         strCutTail              - byte Utility_strCutTail(uint8_t *str, uint8_t *tail);
**
